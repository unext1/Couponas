          ...
          <div className="w-full md:flex">
            ...
            <div className="w-full px-5 py-5 md:w-1/2 md:px-10 bg-brand-dark-600">
              <div className="pb-10 text-center">
                <h1 className="pt-3 text-3xl font-bold text-white">LOGIN</h1>
              ...
              <form onSubmit={(e) => handleLogin(e, email, password)}>
                <div className="flex -mx-3">
                  <div className="w-full px-3 mb-5">
                    ...
                    <div className="flex">
                      ...
                      <input
                        type="email"
                        className="w-full py-2 pl-3 pr-3 -ml-10 border-2 border-gray-200 rounded-lg outline-none focus:border-red-500"
                ...
                <div className="container flex pt-3 pb-10 pl-1 transition duration-100 cursor-pointer hover:text-red-600 ">
                  <Link href="/register">
