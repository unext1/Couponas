  ...
  return (
    <div>
      <header class="bg-white dark:bg-gray-800">
        <nav class="bg-white dark:bg-gray-800">
          <div class="container p-6 mx-auto">
            ...
            <div class="flex items-center justify-center mt-6 text-gray-600 capitalize dark:text-gray-300">
              <a
                href="#"
                class="text-gray-800 dark:text-gray-200 border-b-2 border-blue-600 mx-1.5 sm:mx-6"
              >
                home
              </a>
              ...
              <a
                href="#"
                class="border-b-2 border-transparent hover:text-gray-800 dark:hover:text-gray-200 hover:border-blue-600 mx-1.5 sm:mx-6"
              >
                features
              </a>
        ...
        <div class="container mx-auto px-6 py-12 grid grid-cols-1 md:grid-cols-2">
          <div class="flex flex-col items-center w-full md:flex-row text-center md:text-left">
            <div class="md:pr-32">
              ...
              <div class="mt-6 mb-5 md:mb-0">
                <a
                  href="#"
                  class="block px-4 py-2 font-semibold text-center text-white transition-colors duration-200 transform bg-gradient-to-r from-blue-600 to-purple-700  rounded-md md:inline"
                >
          ...
          <div class="flex items-center justify-center">
            <img
              class="object-cover w-full h-96 rounded-md"
